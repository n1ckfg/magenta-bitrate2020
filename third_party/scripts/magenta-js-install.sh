...
#
#
# An install script for magenta (https://github.com/tensorflow/magenta-js).
# Run with: bash install_magenta-js.sh
...
finish() {
  if (( $? != 0)); then
    ...
    echo "https://github.com/tensorflow/magenta-js"
    echo "==========================================="
    echo ""
  fi
}
...
# Set up the magenta-js environment
echo ""
echo "=============================="
echo "setting up magenta-js environment"
echo "=============================="
echo ""

conda create -n magenta-js python=3.7
...
set -e
if [[ $(conda info --envs | grep "*" | awk '{print $1}') != "magenta-js" ]]; then
  err 'Did not successfully activate the magenta-js conda environment'
fi
...
echo ""
echo "=============================="
echo "Magenta-js Install Success!"
echo ""
echo "NOTE:"
...
echo "conda remove -n magenta-js --all"
echo ""
echo "To run magenta, activate your environment:"
echo "source activate magenta-js"
echo ""
